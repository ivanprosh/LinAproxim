  ...
  ui(new Ui::MainWindow)
{
  ...
  ui->customPlot->plotLayout()->addElement(0, 0, new QCPPlotTitle(ui->customPlot, "Ћинейное сглаживание"));
  ...
  //
  QByteArray encodedString = "¬ведите через пробел массив точек формата 99.9";
